...
public class BrowserExample {  
    ...
    public BrowserExample(Composite parent) {  
        ...
        images = new Image[] { new Image(display, new ImageData("src/com/dianfeng/frame/public_images_css/sign.png")) };  
    ...
    public static void main(String[] args) {  
        ...
        Image icon = new Image(display, new ImageData("src/com/dianfeng/frame/public_images_css/sign.png"));  
        shell.setImage(icon);  
        shell.open();  
